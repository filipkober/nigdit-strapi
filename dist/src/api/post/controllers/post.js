    ...
    return {
        ...
        async getPopSub(ctx) {
            try {
                ...
                /* eslint-disable */ console.log(...oo_oo(`840de58_0`, "Posty z subskrybowanych subnigditów:"));
                /* eslint-disable */ console.log(...oo_oo(`840de58_1`, userSubnigditsIds));
                /* eslint-disable */ console.log(...oo_oo(`840de58_2`, postsIds));
                var i = -1;
                const samples = posts.map((post) => {
                    i += 1;
                    return ({
