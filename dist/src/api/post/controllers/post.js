    ...
    return {
        ...
        async getPopSub(ctx) {
            try {
                ...
                /* eslint-disable */ console.log(...oo_oo(`b8a7ede_2`, postsIds));
                var i = -1;
                const samples = posts.map((post) => {
                    i += 1;
                    return ({
