...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    posts: Attribute.Relation<
      ...
      'api::post.post'
    >;
    subnigdits: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::subnigdit.subnigdit'
    >;
    owned_subnigdit: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::subnigdit.subnigdit'
    >;
    moderates: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::subnigdit.subnigdit'
    >;
    ...
    bans: Attribute.JSON & Attribute.DefaultTo<[]>;
...
export interface ApiCommentComment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    post: Attribute.Relation<
      ...
      'api::post.post'
    >;
    votes: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['Image', 'Gif', 'Video', 'Text']> &
      Attribute.Required;
    votes: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    owner: Attribute.Relation<
      'api::post.post',
      'manyToOne',
      'plugin::users-permissions.user'
    ...
    comments: Attribute.Relation<
      ...
      'api::comment.comment'
    >;
    subnigdit: Attribute.Relation<
      'api::post.post',
      'manyToOne',
      'api::subnigdit.subnigdit'
    >;
    nsfw: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiReportReport extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contentOwner: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    type: Attribute.Enumeration<['post', 'reply', 'comment']> &
      Attribute.Required;
    toSubnigdit: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
    reportMessage: Attribute.Text;
    subnigdit: Attribute.Relation<
      'api::report.report',
      'manyToOne',
      'api::subnigdit.subnigdit'
...
export interface ApiSubnigditSubnigdit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rules: Attribute.Component<'rules.rules', true>;
    ...
    posts: Attribute.Relation<
      ...
      'api::post.post'
    >;
    name_uid: Attribute.UID<'api::subnigdit.subnigdit', 'name'> &
      Attribute.Required;
    contentReports: Attribute.Relation<
      'api::subnigdit.subnigdit',
      'oneToMany',
      'api::report.report'
    > &
